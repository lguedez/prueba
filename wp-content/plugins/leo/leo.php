...
function social_leo($atts) {
 ...
 //finaliza primer `lugins****************************************************************  

register_activation_hook(__FILE__, 'BaseDatos');   // esto se activa cada vez que se activa el plugins
...
add_shortcode('Shor_form', 'Kfp_Aspirante_form');
...
//   finaliza mi segundo plugin************************************************************************

//   tercer plugins plugin************************************************************************
